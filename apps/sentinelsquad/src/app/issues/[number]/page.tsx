      ...
      <div className="grid gap-6 lg:grid-cols-2">
                    ...
                    <div className="mt-2 grid gap-2 sm:grid-cols-2">
                      ...
                      <label className="text-xs text-white/70">
                        ...
                        <input
                          ...
                          placeholder="docs/SENTINELSQUAD_HANDOVER.md#..."
                          className="mt-1 w-full rounded-lg border border-white/15 bg-black/20 px-2 py-1.5 text-sm text-white/90 outline-none focus:border-white/25"
                        />
                      </label>
                    </div>
                    ...
                    <div className="mt-2 grid gap-2 sm:grid-cols-2">
                      ...
                      <label className="text-xs text-white/70">
                        ...
                        <input
                          ...
                          name="handoverRef"
                          required
                          placeholder="docs/SENTINELSQUAD_HANDOVER.md#transfer"
                          className="mt-1 w-full rounded-lg border border-white/15 bg-black/20 px-2 py-1.5 text-sm text-white/90 outline-none focus:border-white/25"
                        />
                      </label>
                    </div>
                    ...
                    <div className="mt-2 grid gap-2 sm:grid-cols-2">
                      <label className="text-xs text-white/70">
                        ...
                        <input
                          ...
                          name="handoverRef"
                          required
                          placeholder="docs/SENTINELSQUAD_HANDOVER.md#close"
                          className="mt-1 w-full rounded-lg border border-white/15 bg-black/20 px-2 py-1.5 text-sm text-white/90 outline-none focus:border-white/25"
                        />
                      </label>
                      <label className="text-xs text-white/70">
                    ...
                    <div className="mt-2 grid gap-2 sm:grid-cols-2">
                      ...
                      <label className="text-xs text-white/70">
                        ...
                        <input
                          ...
                          required
                          placeholder="docs/SENTINELSQUAD_STATUS_BRAINDUMP.md#..."
                          className="mt-1 w-full rounded-lg border border-white/15 bg-black/20 px-2 py-1.5 text-sm text-white/90 outline-none focus:border-white/25"
                        />
                      </label>
                    </div>
        ...
        <div className="rounded-2xl border border-white/12 bg-white/5">
          <div className="border-b border-white/10 px-5 py-4">
            ...
            <div className="mt-1 text-xs text-white/60">
              This creates a task in the SentinelSquad queue. Execution workers come next.
            </div>
          </div>
          <div className="p-5">
            <form
